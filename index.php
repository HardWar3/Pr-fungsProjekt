...
<html>
<head>
<title>Raum-Management-System</title>
<link rel="stylesheet" type="text/css" href="css/style.css" />
<script type="text/javascript" src="db/db.js" defer></script>
<script type="text/javascript" src="js/mainJS.js" defer></script>
</head>
<body>
<script type="text/javascript" >

    var datenbankJsonPage = JSON.parse('<?php echo "{\"etagen\":" . $result[0] . ",\"raeume\":" . $result[1] . ",\"plaetze\":" . $result[2] . "}"?>');
